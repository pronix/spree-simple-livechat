...
desc 'Generate documentation for the simple_livechat extension.'
Rake::RDocTask.new(:rdoc) do |rdoc|
  rdoc.rdoc_dir = 'rdoc'
  rdoc.title    = 'SimpleLivechatExtension'
...
desc 'Test the simple_livechat extension.'
...
namespace :test do
  desc 'Functional test the simple_livechat extension.'
  ...
  desc 'Unit test the simple_livechat extension.'
